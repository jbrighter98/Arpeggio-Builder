...
class Window(Frame):   # this class is the opening window
    ...
    def init_window(self):
        ...
        nb.add(self.page1, text='Chord Builder')
        ...
        def tuningMenu():
            ...
            def savetuningwindow():
                ...
                def savetuning(tuningname):
                    ...
                    filemenu.add_command(label = tuningname, command = lambda: open_tuning(tuningname))
                    root.update()
                ...
                def del_cust(vv):
                    ...
                    for itemname in Q:
                        def new_command1(itemname=itemname):
                            open_tuning(itemname) ######## scroll down to find this function #######
        ...
        for items1 in thetuningnames:
            def new_command(items1=items1):
                open_tuning(items1) ######## scroll down to find this function #######
    ...
    def addingWidgets(self):
        ...
        entry1 = ttk.Entry(labelFrame, textvariable=v)
        entry1.pack()
