def parse(string):
    ...
    flatnote_filter = ['Db', 'Eb', 'Gb', 'Ab', 'Bb','F']
    ...
    def construct_arp(root, name):
        ...
        #     notes = NOTES_FLAT[:]
        if root in flatnote_filter:
            notes = NOTES_FLAT[:]
        elif root not in flatnote_filter and root in NOTES_SHARP:
            notes = NOTES_SHARP[:]
        else:
...
def isMajor3(root, third):
    pass


major_arp_names = [ ['maj7', 'Ionian'],
                    ['major', 'Ionian'],
                    ['min7', 'Dorian'],
                    ['min7', 'Phrygian'],
                    ['maj7', 'Lydian'],
...
minor_arp_names = major_arp_names[5:] + major_arp_names[:5]
